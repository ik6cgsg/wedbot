...
object BotMessages {
    ...
    const val INFO_MESSAGE = """
        ...
        Праздник начнется 27 марта 2026 года в Пушкинской усадьбе (посёлок Фёдоровское, улица Зелёная, дом 1)
        Сбор гостей начнется в в 16:00, официальная часть начнется в 17:00, окончание торжества 23:00
