...
object BotMessages {
    ...
    const val INFO_MESSAGE = """
        Очень важное событие 2 часть
        Будет там-то там-то
        Обязательно заглядывайте в наше /menu за интересностями
    """
    const val HELP_MESSAGE = """
        Если что-то пошло не так, вы всегда можете связаться с админами
        * гейлич
        ** 89119889011
        ** @cgsgilich
        * дерголем
    ...
    const val ADMIN_PING_PROMPT = "Введите текст сообщения для рассылки всем гостям (или отправьте /%s для отмены)"
